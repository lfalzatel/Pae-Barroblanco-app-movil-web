...
export default function RankingGestoresModal({ onClose }: { onClose: () => void }) {
    ...
    const [selectedDocenteForActivity, setSelectedDocenteForActivity] = useState<any | null>(null);
    ...
    return (
        ...
        >
            ...
            {/* Modal de Actividad del Gestor Seleccionado */}
            {selectedDocenteForActivity && (
                <DocenteActivityModal 
                    docente={selectedDocenteForActivity} 
                    onClose={() => setSelectedDocenteForActivity(null)} 
                />
            )}
        </div>
    );
